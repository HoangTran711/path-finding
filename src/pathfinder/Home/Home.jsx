...
export default class Home extends Component {
  ...
  handleRandomWall = () => {
    for(let i = 0; i < 20; i ++) {
      let rowIdx = Number(Math.floor(Math.random() * 51));
      let colIdx = Number(Math.floor(Math.random() * 51)); 
      this.updateNodeType(rowIdx, colIdx, "node-wall") 
    }
  }
  render() {
    return (
      <React.Fragment >
        ...
        <Header
          ...
          handleRandomWall={this.handleRandomWall}
          board={this.board}
        />
        <Board
          board={this.board}
